...
import userImage from 'assets/images/tom-cook.jpg';
import IconSettings from 'components/atoms/icons/IconSettings';
import getUser from 'store/user';
import Logout from 'components/atoms/Logout';
import Search from 'components/molecules/Search';
import menuStore from 'store/menu';
import toggleSearchStore from 'store/search';
...
export default function Header() {
  ...
  const toggleMenu = menuStore((state) => state.toggleMenu);
  const toggleSearch = toggleSearchStore((state) => state.toggleShowSearch);

  return (
    <nav className="bg-white border-b border-gray-200 px-4 py-2.5 fixed left-0 right-0 top-0 z-50">
      <div className="flex flex-wrap gap-6 justify-between items-center relative">
        ...
        <div className="flex items-center lg:order-2">
          <button
            ...
            className="p-2 text-gray-500 rounded-lg md:hidden hover:text-gray-900 hover:bg-gray-100 focus:ring-4 focus:ring-gray-300"
          ...
          >
            ...
            <IconAlert className="text-gray-500 duration-75 group-hover:text-black" />
          </button>
          <div
            className="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white divide-y divide-gray-100 shadow-lg"
          ...
          <div
            className="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white divide-y divide-gray-100 shadow-lgrounded-xl"
            id="apps-dropdown"
          >
            <div className="block py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50">
              Apps
          ...
          <button
            id="user-menu-button"
            type="button"
            className="flex md:mx-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300"
          ...
          <div
            id="dropdown"
            className={`z-50 my-4 w-56 text-base list-none bg-white divide-y divide-gray-100 shadow rounded-xl absolute top-[3.25rem] right-3 ${
              isOpen ? 'block' : 'hidden'
            }`}
          >
